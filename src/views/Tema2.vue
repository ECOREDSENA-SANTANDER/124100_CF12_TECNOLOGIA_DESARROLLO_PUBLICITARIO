  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.align-items-center.justify-content-center.mb-0
      ...
      .col-lg-9.col-md-12.col-12
        p.mb-4 En los últimos años el mundo ha cambiado radicalmente en lo que tiene que ver con comunicación y estrategias de #[em marketing,] esto debido a la llegada inevitable de los nuevos medios de comunicación y plataformas online que derivan su funcionamiento de la conexión permanente. Hoy el mundo está conectado casi en su totalidad, para todo y para todos; sin embargo, el cambio en el #[em marketing] ya había sido advertido por el autor #[em Philip Kotler] en su libro #[em Marketing] 3.0, donde expone cómo en este momento las empresas se conectan de una manera diferente con sus clientes, a través de tres aspectos fundamentales: mente, corazón y espíritu, de una forma más integral como lo recalca el mismo autor.
        p.mb-0 Para entender un poco mejor en qué consiste en #[em inbound,] es necesario hacer referencia al #[em outbound] -desarrollo de acciones por parte de la empresa, con el fin de buscar a los clientes a través de campañas publicitarias realizadas en los medios convencionales-. El mensaje a comunicar con el #[em inbound marketing] es básicamente la exaltación de atributos del producto, ventajas competitivas o beneficios que recibirá el cliente. Además, con los medios convencionales se puede llegar de forma masiva para captar miembros del mercado potencial.

    Separador
    #t_2_1.titulo-segundo.mb-4
      .h2 2.1 ¿En qué consiste el inbound marketing?
    
    .row.align-items-center.justify-content-center.mb-5
      .col-lg-9.col-md-12.col-12
        p.mb-4 El #[em inbound] a diferencia del outbound se centra en la captación de clientes aportándoles valor para que sean ellos mismos, quienes se interesen por acercarse a la marca y ser parte de ella. Para lograr esto, el #[em inbound] utiliza herramientas digitales como el SEO, la analítica #[em web], las redes sociales, los contenidos y la generación de #[em leads.] 
        p.mb-4 Con el #[em inbound] los verdaderos adeptos a la marca serán los que se acerquen a ella, gracias a la empatía que esta genere con ellos al exponerse a los argumentos en cuanto a la propuesta de valor; todas las marcas en el desarrollo de su posicionamiento van adquiriendo rasgos muy distintivos de personalidad que al final identifican a un grupo muy específico de consumidores y cuando estos se ven reflejados en la marca la adoptan como parte de su estilo de vida.
      .col-lg-3.col-md-9.col-9
    ...
    h4.mb-5 ¿Por qué realizar un programa de #[em inbound marketing]?
      ...
      .col-lg-10.col-md-12.col-12
        .row.justify-content.mb-5
          ...
          .col-lg-6.col-md-12.col-12
            ...
            img.img-a.img-t.d-none.d-lg-block.mb-4.mov(src='@/assets/curso/tema2/img8.svg' alt='AvatarTop')
            p.mb-5 #[b Es apto para empresas de todas las actividades económicas,] las que tienen estrategias dirigidas a otras empresas (B2B) implica un mayor número de registros en el sitio web, mientras que las empresas que se enfocan en el consumidor final (B2C) permite un aumento en el volumen de ventas.
