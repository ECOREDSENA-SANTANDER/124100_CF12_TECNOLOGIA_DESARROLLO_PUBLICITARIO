    ...
    TabsB.color-acento-botones.mb-5
      ...
      .py-4.py-md-5(titulo="TicTok" :icono="require('@/assets/curso/tema3/icon3.svg')")
        .row.justify-content-center
          ...
          .col-md-5
            figure
              img(src='@/assets/curso/tema3/img3.svg', alt='TicTok').mx-auto
      ...
      .py-4.py-md-5(titulo="YouTube" :icono="require('@/assets/curso/tema3/icon6.svg')")
        .row.justify-content-center
          ...
          .col-md-6.mb-4.mb-md-0
            p Fundada por Chad Hurley, Steve Chen y Jawed Karim en 2005 en la ciudad de San Bruno, California. Se puede decir que YouTube es una plataforma de televisión en internet, esto porque ya hace presencia en los smart tv y dispositivos de televisión digital. Sin embargo, es en esencia una plataforma para el alojamiento y difusión de material audiovisual. Es el segundo sitio más visitado del mundo después de Google. En esta plataforma se ven más de 5000 millones de videos al día. Por sus funcionalidades también es considerada una red social, donde se permite subir contenido, hacer like, compartir, seguir suscriptores y realizar transmisiones en vivo.
